...
## RXRG
png(filename = paste0('manuscript/figures/rxrg_signal.png'),
    height = 12, width = 24, units = 'cm', res = 300)
grid.newpage()
...
imap(gene_id, function(x, .y) {
  ...
  # RXRG
  plotTracks(list(track_signal$RXRG$`0`,
                  track_signal$RXRG$`4`,
                  track_signal$RXRG$`24`,
                  track_signal$RXRG$`48`,
                  track_signal$RXRG$`72`,
                  track_signal$RXRG$`96`,
                  track_signal$RXRG$`144`),
             type = 'h',
             chromosome = gr_chrom,
             from = gr_start,
             to = gr_end,
